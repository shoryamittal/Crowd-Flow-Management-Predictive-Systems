...
2. **NOT an Autonomous Control System**:
   ...
   - All interventions require human authorization by the **Sector Magistrate or Incident Commander**.
...
4. **NOT "Fully Field Validated"**:
   - The primary demonstration scenario is an **engineered operational model** calibrated to the topology and expected arrival rates of Sector 04 at the Maha Kumbh Mela Prayagraj.
...
To convert 2D video pixel counts into metric spatial density ($\text{devotees}/\text{m}^2$):
...
While the prototype specifically models the **Maha Kumbh Mela (Sector 04 — Sangam Triveni Ghat & Parade Ground)**, the core safety engine is **100% configuration-driven**:
...
- **Pilgrimage Hill Corridors (e.g. Vaishno Devi, Sabarimala)**
